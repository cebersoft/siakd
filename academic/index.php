...
set_include_path('.' . PATH_SEPARATOR . '../library/'
	  ...
	  . PATH_SEPARATOR . '../models/tracerid'
	  . PATH_SEPARATOR . '../models/soap'
	  . PATH_SEPARATOR . '../models/feeder2'
  	  . PATH_SEPARATOR . '../models/fin'
	  . PATH_SEPARATOR . '../models/acv'
	  . PATH_SEPARATOR . '../models/alm'
...
// path public outside root
$path = __FILE__;
$filePath = str_replace('academic\index.php','\\',$path);
